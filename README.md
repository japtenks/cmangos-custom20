...
5. Lastly you will have to install the database changes located in the `src/modules/custom20/sql/install` folder, each folder inside represents where you should execute the queries. E.g. The queries inside of `src/modules/custom20/sql/install/world` will need to be executed in the world/mangosd database, the ones in `src/modules/custom20/sql/install/characters` in the characters database, etc...
